...
class FoundryTestSettings(FoundryBaseSettings):
    ...
    Attributes:
        ...
        foundry_api_key: The Foundry API key used in the test environment.
    ...
    foundry_api_key: str = "test_api_key"
    foundry_project_name: str = "test_project_name"
    foundry_ssh_key_name: str = "test_ssh_key_name"
